...
export default function ServiceSelector() {
	return (
		<div className="shadow-lg flex justify-center bg-black bg-opacity-40 w-max mx-auto py-2 px-4 rounded-full outline outline-offset-0 outline-0 outline-white">
			<button>
				<img
